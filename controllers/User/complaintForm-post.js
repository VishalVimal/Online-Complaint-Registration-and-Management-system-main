...
const { addComplaint } = require("../../demo-data");
...
exports.addComplaint = (req, res) => {
  if (DEMO_MODE) {
    ...
    const complaintData = {
      ...
      imageURL: "https://via.placeholder.com/400x300?text=" + encodeURIComponent(req.body.complaint),
      officerAppointed: "-",
      workStatus: "-",
      approvalStatus: "Pending",
    };
    addComplaint(complaintData);
    console.log("Complaint added in demo mode");
    ...
    cloudinary.uploader.upload(file.tempFilePath, (err, result) => {
      ...
      complaint.save(function (err, result) {
        if (err) {
          ...
          console.log("Successfully complaint Saved to database");
          res.render("complaintSuccess", { userID: req.params.id });
        }
      });
    });
